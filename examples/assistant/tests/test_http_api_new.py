...
# {"bot_id":6,"query":"now","sess_id":"7A7110BF-7A77-4C7A-BEE0-92D5D20BB692"}
...
class TestAPI(unittest.TestCase):
    ...
    def test03_query(self, sess_id="7A7110BF-7A77-4C7A-BEE0-92D5D20BB692"):
        """
        测试eaog/task bot
        """
...
if __name__ == "__main__":
    ...
    # suite.addTest(TestAPI("test01_get_status"))
    # suite.addTest(TestAPI("test02_get_version"))
