...
from rasa_nlu_eliza import utils
from rasa_nlu_eliza.featurizers import Featurizer
...
class WordVectorsFeaturizer(Featurizer):
    ...
    def create(cls, cfg):
        ...
        if vector_file:
            ...
            from rasa_nlu_eliza.models.elmo_cn import Embedder
            model = Embedder(elmo_file)
            category = 'elmo'
        elif bert_file:
            from rasa_nlu_eliza.models.bert.encoder import Encoder
