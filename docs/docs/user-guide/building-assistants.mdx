...
(e.g. [DucklingEntityExtractor](../nlu/components.mdx#DucklingEntityExtractor) or [SpacyEntityExtractor](../nlu/components.mdx#spacyentityextractor)), but for this tutorial
